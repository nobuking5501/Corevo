...
exports.forecastJob = void 0;
const admin = __importStar(require("firebase-admin"));
const scheduler_1 = require("firebase-functions/v2/scheduler");
const date_fns_1 = require("date-fns");
exports.forecastJob = (0, scheduler_1.onSchedule)({
...
async function calculateForecasts(tenantId) {
    const db = admin.firestore();
    ...
    const nextMonth = (0, date_fns_1.format)((0, date_fns_1.addMonths)(new Date(), 1), "yyyy-MM");
    const monthAfter = (0, date_fns_1.format)((0, date_fns_1.addMonths)(new Date(), 2), "yyyy-MM");
